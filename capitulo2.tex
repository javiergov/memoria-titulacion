...
Uno de los componentes que significó una gran ayuda en el desarrollo del cliente es \textit{AV Foundation Framework}, la cual es una estructura de más bajo nivel que \textbf{Media Player Framework} (fig. \ref{IMG-ios-tech-frameworks}) y que permite obtener mayor información de los componentes de un archivo o stream multimedia.
