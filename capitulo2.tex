...
Del diagrama \ref{diagramaGral} se describen los componentes:
\begin{itemize}
\item Segmenter: es una aplicación que recibe como entrada un flujo de audio y/o video encapsulado en MPEG2-Transport Stream, para luego segmentar el contenido en archivos de menor duración, estos se guardan en el sistema de archivos del servidor.
