...
Las bases de esta herramienta se fundan sobre Adobe Flash gracias a su protocolo RTMP. Y considerando el estado actual de las relaciones entre Apple y Adobe (\cite{sota:steve-flash} carta de Steve Jobs, exCEO de Apple Inc.) surge nuestro principal problema:
